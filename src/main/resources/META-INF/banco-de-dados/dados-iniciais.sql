...
insert into cliente (id, nome, cpf) values (1, 'Fernando Medeiros', '93890674054');
insert into cliente (id, nome, cpf) values (2, 'Marcos Mariano', '93890674055');
...
insert into pagamento (pedido_id, status, tipo_pagamento, numero_cartao, codigo_barras) values (2, 'PROCESSANDO', 'cartao', '123', '12345678943651');

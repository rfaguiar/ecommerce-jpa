...
public class EcmMachineMultiTenantConnectionProvider implements
    ...
    public void start() {
        ...
        configurarTenant("algaworks_ecommerce",
                "jdbc:mysql://localhost/ecommerce_jpa?" +
                        "createDatabaseIfNotExist=true&useTimezone=true&serverTimezone=UTC&sessionVariables=sql_mode=''",
                "root",
                "my-secret-pw");

        configurarTenant("loja_ecommerce",
                "jdbc:mysql://localhost/loja_ecommerce_jpa?" +
                        "createDatabaseIfNotExist=true&useTimezone=true&serverTimezone=UTC&sessionVariables=sql_mode=''",
                "root",
                "my-secret-pw");
